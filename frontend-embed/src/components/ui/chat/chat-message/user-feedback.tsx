        ...
        <div className="flex gap-2  ml-auto">
          {feedback === null || feedback === "good" ? (
            <Button
              ...
              className={`transition-transform bg-transparent p-2 rounded-full hover:bg-green-100 ${
                feedback === "good" ? "scale-125" : ""
          ...
          {feedback === null || feedback === "bad" ? (
            <Button
              ...
              size="sm"
              disabled={feedback !== null}
              className={`transition-transform bg-transparent p-2 rounded-full hover:bg-red-100 ${
                feedback === "bad" ? "scale-125" : ""
              } ${feedback !== null ? "cursor-not-allowed" : "cursor-pointer"}`}
