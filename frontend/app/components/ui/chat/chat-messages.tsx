        ...
        <div className="flex flex-col h-full justify-center items-center">
          ...
          <div className="flex-1 p-4 justify-center items-center">
            <div className="flex h-full text-center  justify-center  items-center">
              ...
              <img style={{width: "536px", height: "auto"}} src="https://static.wixstatic.com/media/dfd6da_03bb3d558caf4192b5a17864d5441c33~mv2.png/v1/fill/w_970,h_658,al_c,q_90,usm_0.66_1.00_0.01,enc_auto/Group%204612.png"/>
              </div>
            </div>
          </div>        
