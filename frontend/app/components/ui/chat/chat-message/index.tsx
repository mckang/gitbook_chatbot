...
function ChatMessageContent({
  ...
  const imagesData = getAnnotationData<ImagesData>(
    annotations,
    MessageAnnotationType.IMAGES,
  );
  
  const linksData = getAnnotationData<LinksData>(
    annotations,
    MessageAnnotationType.LINKS,
  );
  ...
  const contents: ContentDisplayConfig[] = [
    ...
    {
      order: 1,
      component: imagesData[0] ? <ChatImages data={imagesData[0]} /> : null,
    },
    {
      order: 1,
      component: linksData[0] ? <ChatLinks data={linksData[0]} /> : null,
    },        
    {
      order: -3,
      component:
